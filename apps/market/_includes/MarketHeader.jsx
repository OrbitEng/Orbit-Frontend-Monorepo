...
export function HomeHeader(props) {
	...
	return(
		<header className="mx-auto max-w-7xl h-14 sm:h-32 sticky flex flex-row justify-between bg-transparent">
			<div className="relative py-auto w-40 align-middle content-start">
				<Image
					src={OrbitLogo}
					layout="fill"
