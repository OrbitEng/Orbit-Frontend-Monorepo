...
export function ChatWidget(props) {
	...
	return (
		<>
			<div className="fixed flex flex-col inset-y-0 right-0 mt-80">
				<button 
					className={"absolute flex flex-col right-0 h-14 w-14 bg-[#251F30] z-[130] rounded-l-lg focus:outline-none"}
			...
			>
				<div className={"pointer-events-auto relative w-screen flex z-[130] mt-14 " + (panel === "text" ? "max-w-3xl" : "max-w-md") }>
					<div className="relative flex flex-col -inset-y-16 right-0 mb-auto mt-32">
						<button 
							className={"relative flex flex-col h-14 w-14  border-l-[1px] border-y-[1px] border-[#545454] border-opacity-30 z-[130] focus:outline-none rounded-l-lg " + (panel === "convos" ? "bg-[#303030]" : "bg-[#251F30]")}
							onClick={() => setPanel("convos")}
						>
							<div className="my-auto mx-auto">
						...
						<button 
							className={"relative flex flex-col h-14 w-14  border-l-[1px] border-y-[1px] border-[#545454] border-opacity-30 z-[130] focus:outline-none rounded-l-lg " + (panel === "text" ? "bg-[#303030]" : "bg-[#251F30]")}
					...
					<div className="flex flex-row backdrop-blur-xl h-[30rem] w-full overflow-hidden bg-gradient-to-t from-[#32254E78] to-[#26232C9C] border-t border-x border-[#545454] border-opacity-30 shadow-xl my-auto rounded-l-xl">
						<div className="absolute top-0 left-0 flex pt-4 pl-4 justify-start">
							<button
								...
								onClick={() => {setChatState(s => ({...s, isOpen: false}))}}
							>
						...
						{panel === "convos" ? (
							<div className="flex flex-col w-full h-full p-3 flex-shrink-0 bg-gradient-to-t from-[#2917514D] to-[#1D045178]">
