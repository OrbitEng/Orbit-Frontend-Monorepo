...
export function SignupForum(props) {
	...
	return(
		<div className="rounded-xl max-w-xl bg-[#141619] py-10 px-20 mx-auto">
			...
			You account is the key to the Orbit marketplace network. Create an account to list and buy products!
			</span>
			...
			<div className="flex flex-col gap-y-4">
				<div className="flex flex-col justify-start gap-y-2">
					...
					<input
						className="rounded-lg p-2 text-white text-xl border-2 border-[#40444F] bg-[#222429] placeholder:font-bold placeholder:text-[#454545]"
...
export function SignupModal(props) {
	...
	return(
		<div className="rounded-xl max-w-lg bg-[#141619] py-10 px-20 mx-auto">
			...
			<div className="flex flex-col gap-y-3">
				...
				<button className="flex flex-row gap-x-2 mt-6 mx-auto text-xl rounded-full font-bold text-white bg-gradient-to-tr from-[#181424] via-buttontransparent2 to-buttontransparent border-t-[0.5px] border-[#474747] bg-transparent align-middle my-auto px-4 py-2">
