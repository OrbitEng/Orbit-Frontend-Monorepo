	...
	return(
		<div className="flex flex-row w-[90%] mx-auto mt-6 mb-20 h-[80vh] gap-8">
			<div className={"h-full w-1/2 p-10 flex flex-col gap-y-5 align-middle text-ellipsis " + (descriptionOpen ? " overflow-y-auto" : " overflow-hidden")}>
				...
				<div className="flex flex-col bg-[#484848] bg-opacity-10 rounded-xl py-5 px-4 w-full bottom-0 overflow-hidden">
					<button
				...
				<div className="flex flex-row w-full justify-center mt-6 mb-auto">
					{
